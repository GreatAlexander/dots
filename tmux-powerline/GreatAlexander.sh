...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		# "ifstat 30 255" \
		"ifstat_sys 30 255  ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}" \
		"lan_ip 24 255  ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}" \
		# "wan_ip 24 255" \
		"vcs_branch 29 88" \
		"vcs_compare 60 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} 60 255 both_disable separator_disable" \
		"vcs_staged 64 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} 64 255 both_disable separator_disable" \
		"vcs_modified 9 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} 9 255 both_disable separator_disable" \
		"vcs_others 245 0 ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD} 245 0 both_disable separator_disable" \
	)
fi
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "cpu 240 136" \
		# "load 237 167" \
		"tmux_mem_cpu_load 234 136 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN} 234 136 both_disable separator_disable" \
		"battery 30 255" \
