...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="GreatAlexander"
	...
	export TMUX_POWERLINE_STATUS_RIGHT_LENGTH="76"
...
# air.sh {
	...
	export TMUX_POWERLINE_SEG_AIR_UPDATE_PERIOD="60"
	# Location of the JSON parser, jq
	export TMUX_POWERLINE_SEG_AIR_JSON="jq"
	# Your location
	# Latitude and Longitude:
	TMUX_POWERLINE_SEG_AIR_LAT="55.953251"
	TMUX_POWERLINE_SEG_AIR_LON="-3.188267"
	# Your Open Weather API Key:
	TMUX_POWERLINE_SEG_AIR_OPEN_WEATHER_API_KEY="599d5f32a0b7f3d641c9583c9c39bf27"
# }
...
# 	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="alex.bordallo"
...
# tmux_mem_cpu_load.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-c -q -v -a 0 -m 2 --interval 2"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="55.953251"
	TMUX_POWERLINE_SEG_WEATHER_LON="-3.188267"
# }
